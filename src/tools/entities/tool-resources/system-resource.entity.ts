...
import { Embeddable, Embedded, Property, Ref } from '@mikro-orm/core';
...
export class SystemResource extends ToolResource {
  ...
  constructor({ files, toolId }: SystemResourceInput) {
    super();
    this.toolId = toolId;
...
export type SystemResourceInput = Pick<SystemResource, 'toolId'> & { files: File[] | Ref<File>[] };
