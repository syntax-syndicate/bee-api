...
@Embeddable({ discriminatorValue: RequiredActionType.APPROVE })
export class RequiredToolApprove extends RequiredAction {
  type = RequiredActionType.APPROVE;
  ...
  constructor({ toolCalls }: RequiredToolApproveInput) {
    super();
    this.toolCalls = toolCalls;
  }
}

export type RequiredToolApproveInput = Pick<RequiredToolApprove, 'toolCalls'>;
